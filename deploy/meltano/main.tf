...
module "meltano" {
  source = "git::https://github.com/meltano/terraform-meltano/terraform.git//kubernetes/modules/meltano?ref=v0.1.0"
  ...
  superset_dependencies   = "'snowflake-sqlalchemy<=1.2.4'"
