...
SELECT
    ...
    COALESCE(project_base.exec_event_success_total, 0) AS exec_event_success_total,
    project_base.is_ci_only,
    COALESCE(project_base.unique_pipelines_count, 0) AS unique_pipelines_count,
    COALESCE(project_base.pipeline_runs_count_all, 0) AS pipeline_runs_count_all,
    COALESCE(project_base.pipeline_runs_count_success, 0) AS pipeline_runs_count_success,
    ...
    COALESCE(project_base.environment_count_success, 0) AS environment_count_success,
    ...
    COALESCE(project_base.plugin_parent_name_count_all, 0) AS plugin_parent_name_count_all,
    COALESCE(project_base.plugin_pip_url_count_all, 0) AS plugin_pip_url_count_all,
    COALESCE(project_base.plugin_name_count_success, 0) AS plugin_name_count_success,
    COALESCE(project_base.plugin_parent_name_count_success, 0) AS plugin_parent_name_count_success,
    COALESCE(project_base.plugin_pip_url_count_success, 0) AS plugin_pip_url_count_success,
    COALESCE(project_base.el_plugin_name_count_all, 0) AS el_plugin_name_count_all,
    COALESCE(project_base.el_plugin_parent_name_count_all, 0) AS el_plugin_parent_name_count_all,
    COALESCE(project_base.el_plugin_pip_url_count_all, 0) AS el_plugin_pip_url_count_all,
    COALESCE(project_base.el_plugin_name_count_success, 0) AS el_plugin_name_count_success,
    COALESCE(project_base.el_plugin_parent_name_count_success, 0) AS el_plugin_parent_name_count_success,
    COALESCE(project_base.el_plugin_pip_url_count_success, 0) AS el_plugin_pip_url_count_success,
    ...
    COALESCE(project_base.non_gsg_pipeline_success, 0) AS non_gsg_pipeline_success,
